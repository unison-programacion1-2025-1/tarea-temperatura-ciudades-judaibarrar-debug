...
df_celsius["Phoenix"] = df_celsius["Phoenix"].apply(kelvin_a_celsius)
df_celsius["San diego"] = df_celsius["San diego"].apply(kelvin_a_celsius)
df_celsius["Toronto"] = df_celsius["Toronto"].apply(kelvin_a_celsius)
# Analisis
